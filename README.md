...
**Form Submittal Page:** Upon submitting the form successfully, the user will be directed to a page that will confirm so, the navigation bar is available if the user wishes to return to the other pages.
...
- [Javascript](https://developer.mozilla.org/en-US/docs/Web/JavaScript 'mozilla.org JavaScript')
    * For show/hide feature of quanity input in survey form.
...
- [Canva](https://www.canva.com/ 'Canva Design')
    * For AI inpainting feature.
- [DeepAI](https://deepai.org/machine-learning-model/text2img 'Text to Image AI image generator')
    * For generating images of author, book covers and book content.
...
- [Github pages](https://pages.github.com/ 'Github Pages')
    * For hosting website.
- [Mockup Generator](https://techsini.com/multi-mockup/index.php 'Mockup Generator')
    * For generating device mockup image.
- [Favicon Generator](https://www.favicon-generator.org/ 'Favicon')
    * Favicons used for social media icons in footer.
...
- HTML has been validated with [W3C HTML5 Validator](https://validator.w3.org/).
    <div align="center">
    <img src="https://github.com/mhesemans/savor-timelessness/blob/main/assets/images/html-validated.png" alt="HTML Validation">
    </div>

- CSS has been validated with [W3C CSS Validator](https://jigsaw.w3.org/css-validator/).

    <div align="center">
    <img src="https://github.com/mhesemans/savor-timelessness/blob/main/assets/images/css-validated.png" alt="CSS Validation">
    </div>

- Links checked with [W3C Link Checker](https://validator.w3.org/checklink).
    <div align="center">
    <img src="https://github.com/mhesemans/savor-timelessness/blob/main/assets/images/links-validated.png" alt="Link Validation">
    </div>
...
- Performance, Accessibility, Best Practices and SEO checked with [PageSpeed](https://pagespeed.web.dev/analysis/ 'PageSpeed Insights')
    ...
    <div align="center">
    <img src="https://github.com/mhesemans/savor-timelessness/blob/main/assets/images/pagespeed-desktop-validation.png" alt="PageSpeed Desktop Validation">
    </div>
...
This website was created for the 1st portfolio project for CodeInstitute while participating in the Full Stack Software Developer Diploma course. Special thanks to my mentor Rory Sheridan for testing, advice and feedback & Cohort Facilitator Amy Richardson for providing advice and documentation.
